...
class EditAnggota extends StatefulWidget {
  ...
  @override
  EditAnggotaState createState() {
    return EditAnggotaState(
      this.id,
      this.nama_lengkap,
      this.jenis_kelamin,
      this.no_telephone,
...
class EditAnggotaState extends State<EditAnggota> {
  final String id;
  final String nama_lengkap;
  final String jenis_kelamin;
  final String no_telephone;
  ...
  EditAnggotaState(this.id, this.nama_lengkap, this.jenis_kelamin,
      this.no_telephone, this.tempat_tanggal_lahir, this.email, this.alamat);
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                controller: namaController..text = nama_lengkap,
